  ...
  return (
    <footer className='flexCenter pb-24 pt-20'>
        <div className='max_padd_container flex w-full flex-col gap-14'>
            ...
            md:flex-row'>
                <Link to='/'className='mb-10 bold-20'>Tienda</Link>
                        ...
                        <FooterColumn>
                            <ul className='flex gap-4'>
                                {SOCIALS.links.map((link) => (
                                    <Link to='/' key={link}><img src={link} alt="socialIcon" width={22} height={22} 
                                    /> </Link>
                                ))}
                            </ul>
                        </FooterColumn>
            ...
            <div className='border-slate-400'>
                <p className='text-center regular-14 text-black'>2024 shoppe</p>
            </div>
        </div>
    </footer>
  )
